    ...
    async with async_session_maker() as session:
        ...
        if not message:
            msg_id = await message_repo.add(
                slug="msg-start",
                text_ru=(
                    "Добро пожаловать на телеканал «Маска» 🎭\n\n"
                    "«Маска» это закрытый платный канал для тех, кто хочет понимать людей глубже, чем принято в обычной психологии и коммуникации \n"
                    "Здесь мы разбираем мышление, поведенческие стратегии, манипуляции, скрытые мотивы и невербальные сигналы, которые в реальной практике используют специалисты, работающие с анализом поведения \n\n"
                    "На канале вы узнаете, как\n\n"
                    "🕵️‍♂️ распознавать манипуляции и скрытое влияние\n"
                    "🔎 видеть несостыковки между словами и действиями\n"
                    "🤝 выстраивать отношения и переговоры осознанно и точно\n"
                    "👀 понимать, что человек на самом деле транслирует поведением, а не словами\n\n"
                    "Часть информации, которой мы делимся, обычно остаётся закрытой и не выносится в публичное поле 🔒\n"
                    "Но здесь вы сможете применять эти знания в обычной жизни в \n"
                    "работе 💼 \n"
                    "бизнесе 📊 \n"
                    "отношениях ❤️ \n"
                    "и коммуникации 💬\n\n"
                    "Формат канала практический \n"
                    "Два раза в неделю выходят видео, где вы\n"
                    "🎓 обучаетесь\n"
                    "📽 наблюдаете реальные примеры\n"
                    "🧩 практикуете\n"
                    "🗣 оставляете обратную связь\n\n"
                    "Если вам важно\n"
                    "не гадать, а понимать\n"
                    "не реагировать, а видеть структуру\n"
                    "не быть объектом влияния, а осознанно управлять взаимодействием\n\n"
                    "Вы на правильном канале\n\n"
                    "Добро пожаловать в «Маску» 🎭✨"
                ),
                text_en="Welcome to the Mask channel! 🎭",
